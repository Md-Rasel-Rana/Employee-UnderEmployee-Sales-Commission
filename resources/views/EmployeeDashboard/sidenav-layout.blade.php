...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/employee")}}" class="side-bar-item">
        ...
        <span class="side-bar-item-caption">Employee Create</span>
    </a>

    <a href="{{url("/Salepage")}}" class="side-bar-item">
        <i class="bi bi-list-nested"></i>
        <span class="side-bar-item-caption">Under Employee</span>
    </a>

    <a href="{{url("/employee-sale")}}" class="side-bar-item">
        <i class="bi bi-bag"></i>
        <span class="side-bar-item-caption">Employee Sale</span>
    </a>
